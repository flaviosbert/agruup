...
exports.concursos.one = function(req, res) {
	...
	req.getConnection(function (err, connection){
		...
		connection.query(stringSQL, id, function(err, rows) {
			if (err) throw err;		
...
exports.concursos.create = function(req, res) {
	...
	req.getConnection(function (err, connection){
		...
		connection.query(stringSQL, concurso, function(err, result) {
			if (err) throw err;
...
exports.concursos.change = function(req, res) {
	...
	req.getConnection(function (err, connection){
		...
		connection.query(stringSQL, [concurso, id], function(err, result) {
			if (err) throw err;
...
exports.concursos.remove = function(req, res) {
	...
	req.getConnection(function (err, connection){
		...
		connection.query(stringSQL, id, function(err, result) {
			if (err) throw err;
			res.json('{ok:true}');		
		});
	});
